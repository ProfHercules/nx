...
function VscodeIntegration(): JSX.Element {
  ...
  return (
    <div className="wrapper my-8 grid h-full items-center md:grid-cols-2 lg:grid-cols-3">
      <div className="lg:col-span-2">
        <div className="w-full dark:hidden">
          <Image
            src="/images/nx-console-light.webp"
        ...
        <div className="hidden w-full dark:block">
          <Image
            src="/images/nx-console-dark.webp"
            alt="Nx Console app screenshot"
            layout={'responsive'}
            loading="lazy"
            width={718}
      ...
      <div className="mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <header className="max-w-xl">
          ...
          <p className="mt-4 text-3xl font-semibold tracking-tight text-slate-900 dark:text-slate-100 sm:text-5xl">
            Make it work in your own terms
          </p>
        </header>
