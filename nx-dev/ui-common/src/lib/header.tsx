...
export function Header(): JSX.Element {
  const flyoutMenu = [
    {
      name: 'Introduction',
      description: 'What is Nx and what to expect?',
      href: '/getting-started/intro',
    },
    {
      name: 'Getting started',
      description: 'Jump right in and start building!',
      href: '/getting-started/core-tutorial',
    },
    {
      name: 'Concepts',
  ...
  return (
    <div className="flex print:hidden">
      <div className="mx-auto flex w-full max-w-7xl items-center justify-between p-4 sm:space-x-10 sm:px-6 lg:px-8">
        {/*LOGO*/}
                  ...
                  >
                    <Popover.Panel className="absolute left-1/2 z-10 mt-3 w-screen max-w-md -translate-x-1/2 transform px-2 sm:px-0 lg:max-w-3xl">
                      <div className="overflow-hidden rounded-lg bg-white shadow-lg ring-1 ring-black/5 dark:bg-slate-900 dark:ring-white/5">
                        ...
                        <div className="bg-gray-50 p-5 dark:bg-slate-800/60 sm:p-8">
                          <Link href="/nx-cloud/intro/what-is-nx-cloud">
                            <a className="-m-3 flow-root rounded-md p-3 transition duration-150 ease-in-out hover:bg-slate-100 hover:dark:bg-slate-800">
                              <span className="flex items-center">
                                <span className="text-base font-medium text-slate-900 dark:text-slate-200">
                                  Nx Cloud
                                </span>
                                <span className="ml-3 inline-flex items-center rounded-full bg-blue-500 px-3 py-0.5 text-xs font-medium leading-5 text-white dark:bg-blue-900 dark:text-slate-300">
                                  Remote caching
                                </span>
                              </span>
                              <span className="mt-1 block text-sm text-slate-500 dark:text-slate-400">
                                Make your workflow even faster by enabling
                                remote caching and distributed task execution on
                                local and CI!
                              </span>
                            </a>
                          </Link>
